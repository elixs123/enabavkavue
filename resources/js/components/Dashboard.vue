<template>
            ...
            <div class="preloader themed-background">
                <h1 class="push-top-bottom text-light text-center"><strong>Enabavka</strong></h1>
                <div class="inner">
            ...
            <div id="page-container" class="sidebar-partial sidebar-visible-lg sidebar-no-animations">
                    ...
                    <div id="sidebar-scroll">
                        ...
                        <div class="sidebar-content">
                            ...
                            <a href="index.html" class="sidebar-brand">
                                <i class="gi gi-flash"></i><span class="sidebar-nav-mini-hide"><strong>Enabavka</strong></span>
                            </a>
                            <!-- END Brand -->
                ...
                <div id="main-container">
                    ...
                    <!-- Page content -->
                    <div id="page-content" style="min-height: 100vh;">
                        <!-- Page Header -->
                    ...
                    <footer class="clearfix">
                        ...
                        <div class="pull-left">
                            <span id="year-copy"></span> &copy; <a href="https://1.envato.market/x4R" target="_blank">Enabavka</a>
                        </div>
                    </footer>
                    <!-- END Footer -->
                </div>
